...
class Text01 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [ 
      ...
      TextContent(h: "The ultimate app where we prioritise your convenience over anything else. Free up your time and do what matters most.")
    ],
    );
  }
}
...
class Text02 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [ 
      ...
      SizedBox(height: 24.h,),
      TextContent(h: "From housekeeping to property management and more. Each service is designed specifically to your every needs")
    ],
    );
  }
}
...
class Text03 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [ 
      ...
      SizedBox(height: 24.h,),
      TextContent(h: "Can’t find what you’re looking for? Speak to your personal concierge and leave the heavy lifting to us.")
    ],
    );
  }
}
...
class Text04 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [ 
      ...
      SizedBox(height: 24.h,),
      TextContent(h: "With just a few simple taps, we will accomplish any tasks for you. No task too big, no task too difficult")
    ],
    );
  }
}
